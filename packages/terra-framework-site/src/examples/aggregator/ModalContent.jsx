...
class ModalContent extends React.Component {
  ...
  disclose(size) {
    return () => {
      const identifier = `ModalContent-${Date.now()}`;
...
const disclosureKey = 'ModalContent';
AppDelegate.registerComponentForDisclosure(disclosureKey, ModalContent);
